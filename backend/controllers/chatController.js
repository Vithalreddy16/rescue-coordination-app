...
const getChatbotResponse = (message) => {
    ...
    if (msg.includes('report') || msg.includes('emergency')) {
        ...
        return "If you see a fire, evacuate the area immediately. Close doors behind you to contain the fire. Call your local emergency number (like 911 or 112) once you are in a safe location.";
